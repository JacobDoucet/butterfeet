#!/usr/bin/env bash
# validate-bad-stories-content.sh
# Validates all story pack JSON files under apps/bad-stories/content/packs.
#
# Fails if:
#   - JSON is invalid
...
PACKS_DIR="$ROOT_DIR/apps/bad-stories/content/packs"
ERRORS=0

...
// Bad Stories ships on warm Paper with deep Ink and a single Highlight yellow.
...
val BadStoriesPackPalettes: Map<String, PackPalette> = mapOf(
    ...
    "reality-tv"         to PackPalette(Color(0xFFE91E63), Color(0xFFFFC857), "Unhinged"),
    "science-fiction"    to PackPalette(Color(0xFF3A86FF), Color(0xFF8338EC), "Cosmic"),
    "crime-documentary"  to PackPalette(Color(0xFF5D2E2E), Color(0xFFE6B450), "Suspicious"),
...
fun paletteForPack(packId: String, available: Boolean = true): PackPalette {
    ...
    return BadStoriesPackPalettes[packId] ?: PackPalette(
        primary = ChaosOrange,

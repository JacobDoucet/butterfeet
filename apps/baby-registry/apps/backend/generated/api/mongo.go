...
func NewMongoBackedClient(db *mongo.Database) Client {
	return &mongoClient{
		...
		cart:                   cart_api.NewMongoBackedClient(db),
		...
		registryPaymentMethod:  registry_payment_method_api.NewMongoBackedClient(db),
...
func (c *mongoClient) Cart() cart_api.Client {
	return c.cart
}
...
func (c *mongoClient) RegistryPaymentMethod() registry_payment_method_api.Client {

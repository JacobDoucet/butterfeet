...
func ToHTTPMutationResult(obj registry_payment_method.Model, projection registry_payment_method.Projection) (HTTPMutationResult, error) {
...
type HTTPModel struct {
	registry_payment_method.HTTPRecord `json:"registryPaymentMethod"`

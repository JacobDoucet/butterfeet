...
export function useEventTypeDataGridColumn(options: EventTypeDataGridColumnOptions) { 
    const values = useMemo(() => [
            {
                value: 'ItemAdded',
                label: options.getOptionLabel('ItemAdded'),
            },
            {
                value: 'ItemDeleted',
                label: options.getOptionLabel('ItemDeleted'),
            },
            {
                value: 'ItemReserved',
                label: options.getOptionLabel('ItemReserved'),
            },
            {
                value: 'ItemUpdated',
                label: options.getOptionLabel('ItemUpdated'),
            },
            {
                value: 'OwnerLoggedIn',
                label: options.getOptionLabel('OwnerLoggedIn'),
            },
            {
                value: 'RegistryCreated',
                label: options.getOptionLabel('RegistryCreated'),
            },
            {
                value: 'RegistryDeleted',
                label: options.getOptionLabel('RegistryDeleted'),
            },
            {
                value: 'RegistryUpdated',
                label: options.getOptionLabel('RegistryUpdated'),
            },
            {
                value: 'ReservationCancelled',
                label: options.getOptionLabel('ReservationCancelled'),
            },
...
type EventUpdatedByOwnerUserDataGridColumnOptions = {
    headerName?: string;
    width?: number;
    sortable?: boolean;
    hideable?: boolean;
...
export const EventUpdatedByOwnerUserDataGridColumnKey = 'updatedByOwnerUser' as const;

export function useEventUpdatedByOwnerUserDataGridColumn(options: EventUpdatedByOwnerUserDataGridColumnOptions) {

    return useMemo<GridColDef<EventWithRefs>>(() => ({
        headerName: options.headerName ?? EventUpdatedByOwnerUserDataGridColumnKey,
        width: options.width,
        sortable: options.sortable,
        hideable: options.hideable,
        field: EventUpdatedByOwnerUserDataGridColumnKey,
        valueGetter: (_, row) => { 
            return options.getValue ? options.getValue(row) : row.event.updatedByOwnerUser;
        },
        type: undefined,
        renderCell: options.renderCell,
    }), [
